...
export const UtilizationPricing: React.FC<UtilizationPricingProps> = ({
    ...
    channelPricing = [
        { icon: "MessageSquare", channel: "Text/Chat", price: "$0.02", unit: "per message" },
        { icon: "Phone", channel: "Phone", price: "$0.08", unit: "per minute" },
        { icon: "Mic", channel: "Voice", price: "$0.05", unit: "per minute" },
    ],
